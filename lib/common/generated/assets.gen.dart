...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icone-search.svg
  SvgGenImage get iconeSearch =>
      const SvgGenImage('assets/icons/icone-search.svg');

  /// List of all assets
  List<SvgGenImage> get values => [iconeSearch];
}
